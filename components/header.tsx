  ...
  return (
    <header className="fixed top-0 w-full border-b bg-white/95 backdrop-blur z-50 supports-[backdrop-filter]:bg-white/60">
      ...
      <div className="flex items-center gap-4">
        <Authenticated>
          <Link href="/dashboard">
          <Button variant={"outline"} className="hidden md:inline-flex items-center gap-2 hover:text-green-600 border-green-600 transition">
      ...
      {isLoading && <BarLoader width={"100%"} color="#0df352" />}
    </header>
  )
}
